      ...
      <Typewriter
        onInit={(typewriter) => {
          typewriter
            ...
            .pauseFor(3500)
            .deleteAll(17)
            .typeString('<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Front-end Developer</span>')
            .pauseFor(3500)
            .deleteAll(17)

            .typeString('<span style="color: #f59e0b; font-size: 14px; font-weight: 400;">Back-end Developer</span>')
            .pauseFor(3500)
            .deleteAll(17)
